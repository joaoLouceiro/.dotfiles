...
map('n','gs','<cmd>lua vim.lsp.buf.signature_help()<CR>', { desc = "LSP: signature_help"} )
map('n','gi','<cmd>lua vim.lsp.buf.implementation()<CR>', { desc = "LSP: implementation"} )
map('n','gt','<cmd>lua vim.lsp.buf.type_definition()<CR>', { desc = "LSP: type_definition"} )
map('n','<leader>gw','<cmd>lua vim.lsp.buf.document_symbol()<CR>', { desc = "LSP: document_symbol"} )
map('n','<leader>gW','<cmd>lua vim.lsp.buf.workspace_symbol()<CR>', { desc = "LSP: workspace_symbol"} )
map('n','<leader>ah','<cmd>lua vim.lsp.buf.hover()<CR>', { desc = "LSP: hover"} )
map('n','<leader>af','<cmd>lua vim.lsp.buf.code_action()<CR>', { desc = "LSP: code_action"} )
map('n','<leader>ee','<cmd>lua vim.lsp.util.show_line_diagnostics()<CR>', { desc = "LSP: "} )
map('n','<leader>ar','<cmd>lua vim.lsp.buf.rename()<CR>', { desc = "LSP: rename"} )
map('n','<leader>=', '<cmd>lua vim.lsp.buf.formatting()<CR>', { desc = "LSP: formatting"} )
map('n','<leader>ai','<cmd>lua vim.lsp.buf.incoming_calls()<CR>', { desc = "LSP: incoming_calls"} )
map('n','<leader>ao','<cmd>lua vim.lsp.buf.outgoing_calls()<CR>', { desc = "LSP: outgoing_calls"} )
